...
extern "C"
{
    DLL_IMPORT double v_P_T_R4(double,double);
	DLL_IMPORT double u_P_T_R4(double,double);
	DLL_IMPORT double s_P_T_R4(double,double);
	DLL_IMPORT double h_P_T_R4(double,double);
	DLL_IMPORT double cp_P_T_R4(double,double);
	DLL_IMPORT double cv_P_T_R4(double,double);
	DLL_IMPORT double w_P_T_R4(double,double);
}
